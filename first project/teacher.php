...
<?php $i=0;
    ...
    <tr>
        ...
        <td>
            <?php echo "<a href='teacher.php?action=edite&id=".$value['ID']."'>Edit</a>";?> || <?php echo "<a onclick='return confirm(\"are you sure to delet data\")' href='teacher.php?action=delate&id=".$value['ID']." '>Delate</a>";?>
        </td>
    </tr>
